...
// Chame a função de inicialização se não estiver no DOMContentLoaded
// window.onload = carregarDados; // Alternativa se DOMContentLoaded não funcionar por algum motivo